            ...
            <main class="content">
                <div class="container-fluid p-0">
                    <div class="d-flex justify-content-between mb-4">
                        <h1 class="h3">Data Pembayaran UKT</h1>
                        <a href="ukt_add.php" class="btn btn-primary">Tambah Data</a>
                    </div>
                    <div class="row">
                        <div class="col-12">
                            <div class="card">
                                <div class="card-body px-5">
                                    <table id="example" class="ui celled table">
                                        ...
                                        <tbody>
                                            ...
                                            $no = 1;
                                            $data = mysqli_query($connection, "select * from pembayaran_ukt, mahasiswa where pembayaran_ukt.nim = mahasiswa.nim");
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <?php if ($d['status'] == 'Selesai') { ?>
                                                            <span class="badge rounded-pill bg-success py-2 px-2"><?php echo $d['status']; ?></span>
                                                        <?php } ?>
                                                        <?php if ($d['status'] == 'Pending') { ?>
                                                            <span class="badge rounded-pill bg-warning py-2 px-2"><?php echo $d['status']; ?></span>
                                                        <?php } ?>
                                                        <?php if ($d['status'] == 'Sedang diproses') { ?>
                                                            <span class="badge rounded-pill bg-primary py-2 px-2"><?php echo $d['status']; ?></span>
                                                        <?php } ?>
                                                    </td>
                                                    <td>
